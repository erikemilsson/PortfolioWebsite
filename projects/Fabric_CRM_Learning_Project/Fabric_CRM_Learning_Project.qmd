...
Yale EPI data is published annually in csv files and can be found [here](https://epi.yale.edu/downloads). I uploaded the files to my github portfolio repository because they couldn't be uploaded directly to Fabric as it wasn't tied to a OneDrive for Business account.

### Create a data warehouse (tbc)
